...
FROM 'D:\SQL PROJECT- Online book store\.Csv Files\Books.csv'
WITH (FORMAT csv, HEADER true);

COPY Customers(Customer_ID, Name, Email, Phone, City, Country)
FROM 'D:\SQL PROJECT- Online book store\.Csv Files\Customers.csv'
WITH (FORMAT csv, HEADER true);

COPY Orders(Order_ID, Customer_ID, Book_ID, Order_Date, Quantity, Total_Amount)
FROM 'D:\SQL PROJECT- Online book store\.Csv Files\Orders.csv'
WITH (FORMAT csv, HEADER true);
